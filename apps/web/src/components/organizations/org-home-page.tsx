...
/**
 * Connect GitLab: import the signed-in maintainer's projects as UNCLAIMED repos
 * (webhook registered per project), then land on the claim screen to bind them
 * to an org — the GitLab half of "connect {forge} repos". User-scoped, so it is
 * not gated on org-admin; the claim that follows is the admin act.
 */
